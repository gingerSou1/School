...
for a_index in datafile_to_dict['STATE']:
    ...
    state_dict[datafile_to_dict['STATE']
    [a_index]]['Capital'] = datafile_to_dict['CAPITAL'][a_index]
    state_dict[datafile_to_dict['STATE']
    [a_index]]['State'] = datafile_to_dict['STATE'][a_index]
    state_dict[datafile_to_dict['STATE']
    [a_index]]['Flower'] = datafile_to_dict['FLOWER'][a_index]
    state_dict[datafile_to_dict['STATE']
    [a_index]]['Population'] = datafile_to_dict['POPULATION'][a_index]
    state_dict[datafile_to_dict['STATE']
    [a_index]]['URL'] = datafile_to_dict['URL'][a_index]
